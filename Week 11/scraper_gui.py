...
def main_window():
    ...
    header = tk.Label(root, text="Car Price Scraper Dashboard", font=("Arial", 18, "bold"), bg="#f5f5f5")
    header.pack(pady=10)
    ...
    search_btn = tk.Button(frame, text="Search", command=search, bg="#4CAF50", fg="white", font=("Arial", 11, "bold"))
...
tk.Label(splash, text="Car Scraper Loading...", font=("Arial", 12, "bold")).pack(expand=True)
splash.after(1500, start_app) 
